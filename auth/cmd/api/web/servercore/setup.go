...
func (srv *Server) registerRoutes() {
	...
	group.Post("/register", srv.NewUser())
	group.Patch("/verify", srv.VerifyAccount())
	group.Post("/login", srv.LoginAccount())
	group.Post("/new_password", srv.NewPassword())
	group.Patch("/change_password", srv.ChangePassword())
}

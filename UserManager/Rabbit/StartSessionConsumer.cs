...
public class StartSessionConsumer(string exchange, string queue, string route, RabbitConn conn, IServiceScopeFactory scopeFactory) : RabbitConsumer(exchange, queue, route, conn)
{
